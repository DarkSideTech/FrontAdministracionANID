...
export const GOV_CL_ICON_REGISTRY = {
  ...
  emailEdit: {
    viewBox: '0 0 24 24',
    paths: [
      'M20 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H13V18H4V8L12 13L20 8V13H22V6C22 4.9 21.1 4 20 4ZM12 11L4 6H20L12 11Z',
      'M17.75 21H16V19.25L20.06 15.19L21.81 16.94L17.75 21ZM22.71 16.04L21.96 16.79L20.21 15.04L20.96 14.29C21.15 14.1 21.46 14.1 21.66 14.29L22.71 15.34C22.9 15.54 22.9 15.85 22.71 16.04Z',
    ],
  },
