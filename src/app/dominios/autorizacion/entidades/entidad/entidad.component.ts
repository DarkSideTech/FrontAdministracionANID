...
export class EntidadComponent implements OnInit  {
  ...
  tipoEntidadType = [
    { id: '1', value: 'PERSONA' },
    { id: '2', value: 'INSTITUCION' },
    { id: '3', value: 'UNIDAD_ORGANIZACIONAL' },    
  ];

  entidadesExistentesType = [
    { id: '1', value: 'Universidad de Chile' },
    { id: '2', value: 'ANID' },
    { id: '3', value: 'Juan Jimenez' },    
  ];
  ...
  constructor(
    ...
    this.editForm = this.fb.group({
      ...
      tipoEntidad: new UntypedFormControl(),
  ...
  fetch(cb: any) {
    ...
    req.open('GET', 'assets/data/entidades-tbl-data.json');
    req.onload = () => {
  ...
  onEditSave(form: UntypedFormGroup) {
    this.data = this.data.filter((value, key) => {
      if (value.id == form.value.id) {
        value.tipoEntidad == form.value.tipoEntidad,
        value.idEntidad == form.value.idEntidad,
  ...
  activateRecordSuccess() {
    this.toastr.success('Se Activo la Entidad correctamente', '');
  }
  desactivateRecordSuccess() {
    this.toastr.success('Se Desactivo la Entidad correctamente', '');
  }
  editRecordSuccess() {
