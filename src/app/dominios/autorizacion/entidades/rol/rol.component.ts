...
export class RolComponent implements OnInit  {
  ...
  columns = [
    ...
    { name: 'Nombre' },
    { name: 'Descripcion' },    
    { name: 'RequiereAccionParaSerAsignado' },
    { name: 'ValidaAsignacionDeRolesConRequerimientoActivo' },
    { name: 'ActivaDetalleDeAutorizaciones' },
    { name: 'Activo' },
  ];
  booleanoType = [
    { id: '1', value: true },
  ...
  constructor(
    ...
    this.editForm = this.fb.group({
      ...
      requiereAccionParaSerAsignado: new UntypedFormControl(),
      validaAsignacionDeRolesConRequerimientoActivo: new UntypedFormControl(),
      activaDetalleDeAutorizaciones: new UntypedFormControl(),
  ...
  ngOnInit() {
    ...
    this.register = this.fb.group({
      ...
      nombre: [''],
      descripcion: [''],
      requiereAccionParaSerAsignado: [''],
      validaAsignacionDeRolesConRequerimientoActivo: [''],
  ...
  fetch(cb: any) {
    ...
    req.open('GET', 'assets/data/roles-tbl-data.json');
    req.onload = () => {
  ...
  editRow(row: any, rowIndex: number, content: any) {
    ...
    this.editForm.setValue({
      ...
      requiereAccionParaSerAsignado: row.requiereAccionParaSerAsignado,
      validaAsignacionDeRolesConRequerimientoActivo: row.validaAsignacionDeRolesConRequerimientoActivo,
      activaDetalleDeAutorizaciones: row.activaDetalleDeAutorizaciones,
      activo: row.activo,
    });
  ...
  onEditSave(form: UntypedFormGroup) {
    this.data = this.data.filter((value, key) => {
      if (value.id == form.value.id) {
        ...
        value.requiereAccionParaSerAsignado == form.value.requiereAccionParaSerAsignado;
        value.validaAsignacionDeRolesConRequerimientoActivo == form.value.validaAsignacionDeRolesConRequerimientoActivo;
        value.activaDetalleDeAutorizaciones == form.value.activaDetalleDeAutorizaciones;
  ...
  activateRecordSuccess() {
    this.toastr.success('Se Activo el Rol correctamente', '');
  }
  desactivateRecordSuccess() {
    this.toastr.success('Se Desactivo el Rol correctamente', '');
  }
  editRecordSuccess() {
